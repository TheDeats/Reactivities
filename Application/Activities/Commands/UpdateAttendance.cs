...
public class UpdateAttendance
{
    ...
    public class Hanlder(IUserAccessor userAccessor, AppDbContext context) : IRequestHandler<Command, Result<Unit>>
    {
        public async Task<Result<Unit>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            ActivityAttendee? userAttendance = activity.Attendees.FirstOrDefault(x => x.UserId == user.Id);
